...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
        ...
        public float CameraShakeMaster = 1;
        ...
        {
            CameraShakeInstance shake = new CameraShakeInstance(magnitude * (CameraShakeModifier * CameraShakeMaster), roughness, fadeInTime, fadeOutTime);
        ...
        {
            CameraShakeInstance shake = new CameraShakeInstance(magnitude * (CameraShakeModifier * CameraShakeMaster), roughness);
            shake.PositionInfluence = DefaultPosInfluence;
            shake.RotationInfluence = DefaultRotInfluence;
        ...
        {
            Instance.DefaultPosInfluence = new Vector3(0, 0, 0);
            Instance.DefaultRotInfluence = new Vector3(10, 1, 1);
        }
    }
}